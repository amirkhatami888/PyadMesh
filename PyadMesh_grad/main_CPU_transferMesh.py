...
def tranferMesh(csvFile,inpFile,datFile,savePath,error_thereshold):
...
if __name__ == "__main__":
    ...
    datFile=sys.argv[3]
    savePath=sys.argv[4]
    error_thereshold=float(sys.argv[5])
    
    tranferMesh(csvFile,inpFile,datFile,savePath,error_thereshold)
    time_end = time.time()
